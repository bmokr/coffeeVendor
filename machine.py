...
class Machine:
    ...
    def __init__(self):
        ...
        self.products = cont.Products()  # Initialize used containers like dictionary classes
    ...
    def check_balance(self):  # method checking machine stored money state
        for value in self._money.values():  # sprawdzic czy nie pusty wczesniej
            if value != 0:
                return True
        return False
    ...
    def service_task(self):  # method allowing change machine properties
        ...
        if which_service == "1" and self.access_flag:
        ...
        # elif which_service == "2" and self.access_flag:
        #     plnIn = input("Input pln: ")
        #     usdIn = input("Input usd: ")
        #     #self.moneySet(self.getAccessFlag(), plnIn, usdIn)
        #     self.access_flag = False
        # elif which_service == "3" and self.access_flag:
        #     #self.setProducts(self.getAccessFlag())
        #     self.access_flag = False
        # elif which_service == "4" and self.access_flag:
